$(function(){
    ...
    var base_url='http://localhost/salao/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        dayClick: function(date, event, view) {
         ...
         eventDrop: function(event, delta, revertFunc) {  
               ...
               $.post(base_url+'agenda/dragUpdateEvent',{
                id:event.id,
    ...
    $('.modal').on('click', '#add-event',  function(e){
        if(validator(['clientes', 'description', 'profissionais'])) {
            $.post(base_url+'agenda/addEvent', {
                id_profissional: $('#profissionais').val(),
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['clientes', 'description', 'profissionais'])) {
            $.post(base_url+'agenda/updateEvent', {
                id: currentEvent._id,
                id_profissional: $('#profissionais').val(),
                id_cliente: $('#clientes').val(),
                description: $('#description').val(),
    ...
    $('.modal').on('click', '#delete-event',  function(e){
        $.get(base_url+'agenda/deleteEvent?id=' + currentEvent._id, function(result){
            $('.modal').modal('hide');
            $('#calendar').fullCalendar("refetchEvents");
        });
    });
    ...
    function validator(elements) {
        ...
        if(errors) {
            $('.error').html('Por favor, preencha todos os campos abaixo.');
            return false;
        }
        return true;
    }
