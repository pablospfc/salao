            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <a class="btn btn-success" href="javascript:;" onclick="janelaDetalhamentoCliente(<?= $cliente->id ?>)">
                                <i class="halflings-icon white zoom-in"></i>
                            </a>
                            <a class="btn btn-info" href="<?php echo base_url('cliente/view/'.$cliente->id)?>">
                                <i class="halflings-icon white edit"></i>
                            </a>
                            <a class="btn btn-danger confirma_exclusao" href="#" data-id="<?= $cliente->id ?>" data-nome="<?= $cliente->nome ?>">
