...
<head>
    ...
    <!--<link type='text/css' href="<?php //echo base_url();?>includes/css/checkbox.css" rel="stylesheet" />-->
        ...
        <div class="container-fluid">
            ...
            <div class="nav-no-collapse header-nav">
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="halflings-icon white user"></i> <?php echo $this->session->userdata('login');  ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo site_url('usuario/view/'.$this->session->userdata('id')); ?>"><i class="halflings-icon user"></i> Conta</a></li>
                            <li><a href="<?php echo site_url('login/logout'); ?>"><i class="halflings-icon off"></i> Sair</a></li>
                        </ul>
                    </li>
                    <!-- end: User Dropdown -->
                </ul>
