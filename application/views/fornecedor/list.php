    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Detalhamento do Fornecedor</h4>
            </div>
            <div class="modal-body">
                <table class="table table-striped table-bordered bootstrap-datatable" id="detalhe">
                    ...
                    <tr>
                        ...
                        <td><label id="site"></label></td>
                    </tr>

                    <tr>
                        <td><strong>Inscrição Estadual:</strong></td>
                        <td><label id="inscricao_estadual"></label></td>
                    </tr>

                    <tr>
                        <td><strong>Inscrição Municipal:</strong></td>
                        <td><label id="inscricao_municipal"></label></td>
                    </tr>
...
<div class="modal fade" id="modal_confirmation">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Deseja realmente excluir o fornecedor <strong><span id="nome_exclusao"></span></strong>?</p>
            </div>
            <div class="modal-footer">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#btn_excluir').click(function(){
            ...
            document.location.href = base_url + "fornecedor/del/"+id;
        });
    });

    function carregaDadosFornecedorJSon(id_fornecedor){

        $.post(base_url+'fornecedor/getInfoFornecedor', {
            ...
            $('#cnpj').text(data.cnpj);
            $('#site').text(data.site);
            $('#inscricao_estadual').text(data.inscricao_estadual);
            $('#inscricao_municipal').text(data.inscricao_municipal);

        }, 'json');
    }

    function janelaDetalhamentoFornecedor(id_fornecedor){

        //antes de abrir a janela, preciso carregar os dados do fornecedor e preencher os campos dentro do modal
