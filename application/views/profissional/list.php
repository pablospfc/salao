    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>Profissionais</h2>
                <div class="box-icon">
                    <a href="<?php echo site_url('profissional/add'); ?>" class="btn btn-primary btn-sm"> <i
            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                    <?php foreach($list_profissionais as $profissional): ?>
                    <tr>
                        <td><?php echo $profissional->nome;?></td>
                        <td class="center"><?php echo $profissional->telefone;?></td>
                        <td class="center"><?php echo $profissional->celular;?></td>
                        <td class="center">
                            <?php echo $profissional->email;?>
                        </td>
                        <td class="center">
                            <a class="btn btn-success" href="javascript:;" onclick="janelaDetalhamentoProfissional(<?= $profissional->id ?>)">
                                <i class="halflings-icon white zoom-in"></i>
                            </a>
                            <a class="btn btn-info" href="<?php echo base_url('profissional/view/'.$profissional->id)?>">
                                <i class="halflings-icon white edit"></i>
                            </a>
                            <a class="btn btn-danger confirma_exclusao" href="#" data-id="<?= $profissional->id ?>" data-nome="<?= $profissional->nome ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Detalhamento do Profissional</h4>
            </div>
...
<div class="modal fade" id="modal_confirmation">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Deseja realmente excluir o profissional <strong><span id="nome_exclusao"></span></strong>?</p>
            </div>
            <div class="modal-footer">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#btn_excluir').click(function(){
            ...
            document.location.href = base_url + "profissional/del/"+id;
        });
    });

    function carregaDadosProfissionalJSon(id_profissional){

        $.post(base_url+'profissional/getInfoProfissional', {
    ...
    function janelaDetalhamentoProfissional(id_profissional){

        //antes de abrir a janela, preciso carregar os dados do profissional e preencher os campos dentro do modal
        carregaDadosProfissionalJSon(id_profissional);
