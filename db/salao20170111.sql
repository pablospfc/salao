...
CREATE TABLE `tb_venda` (
  ...
  `data` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tb_venda_tb_servico1_idx` (`id_servico`),
  KEY `fk_tb_venda_tb_produto1_idx` (`id_produto`),
  KEY `fk_tb_venda_tb_profissional1_idx` (`id_profissional`),
  KEY `fk_tb_venda_tb_cliente1_idx` (`id_cliente`),
  CONSTRAINT `fk_tb_venda_tb_cliente1` FOREIGN KEY (`id_cliente`) REFERENCES `tb_cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_venda_tb_produto1` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_venda_tb_profissional1` FOREIGN KEY (`id_profissional`) REFERENCES `tb_profissional` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_venda_tb_servico1` FOREIGN KEY (`id_servico`) REFERENCES `tb_servico` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-01-11  9:34:11
